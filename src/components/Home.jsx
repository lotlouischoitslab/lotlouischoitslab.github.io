  ...
  return (
    <div name='home' className="w-full h-screen bg-[black]">
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <h1 className='text-3xl sm:text-7xl font-bold text-[#ccd6f6]'>Louis Sungwoo Cho</h1>
            <h1 className='text-2xl sm:text-5xl font-bold text-[#ccd6f6]'>조성우</h1>
            <h2 className='text-2xl sm:text-3xl font-bold text-[#ccd6f6]'>I am a Transportation Engineer and a Computer Scientist</h2>
